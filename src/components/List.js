  ...
  return (
    <div className='grid grid-cols-1 gap-4 mt-2  '>
      ...
      {data.map((country) => (
        <div
          key={country.name}
          className=' rounded-lg shadow border border-gray-300 bg-white px-6 py-3  flex items-center justify-center space-x-10 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500'>
          <div className=' w-48'>
