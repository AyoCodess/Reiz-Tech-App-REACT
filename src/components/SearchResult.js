      ...
      {data.map((country) => {
        return (
          <div
            ...
            key={country.name}
            className={`rounded-lg border border-green-500 bg-white px-6 py-5 shadow flex items-center justify-center space-x-10 hover:border-blue-500  cursor-pointer ${customStyles}`}>
            <div className=' w-48'>
